			...
			<table class="table">
				...
				<c:forEach items="${deduList}" var="dedu">
					<tr align="center">
						...
						<td>${dedu.addtime}</td>
						<td>${dedu.memo}</td>
						<td><a href="dedu/getDeduById.action?id=${dedu.deduid}"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;<a
							href="dedu/deleteDedu.action?id=${dedu.deduid}" onclick="{if(confirm('确定要删除吗?')){return true;}return false;}"><i

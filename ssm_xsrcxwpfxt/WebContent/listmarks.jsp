			...
			<table class="table">
				...
				<c:forEach items="${marksList}" var="marks">
					<tr align="center">
						...
						<td>${marks.addtime}</td>
						<td>${marks.memo}</td>
						<td><a href="marks/getMarksById.action?id=${marks.marksid}"><i class="fa fa-pencil"></i></a>&nbsp;&nbsp;<a
							href="marks/deleteMarks.action?id=${marks.marksid}" onclick="{if(confirm('确定要删除吗?')){return true;}return false;}"><i

		...
		<div class="main-content">
			<table class="table">
				...
				<c:forEach items="${deduList}" var="dedu">
					<tr align="center">
						<td class="center">${dedu.realname}</td>
						<td class="center">${dedu.srealname}</td>
						<td class="center">${dedu.title}</td>
						<td class="center">${dedu.reason}</td>
						<td class="center">${dedu.num}</td>
						<td class="center">${dedu.addtime}</td>
						<td class="center">${dedu.memo}</td>
					</tr>
				</c:forEach>
			</table>
			<ul class="pagination">
				<li>
					<form action="dedu/queryDeduByCond.action" name="myform" method="post">

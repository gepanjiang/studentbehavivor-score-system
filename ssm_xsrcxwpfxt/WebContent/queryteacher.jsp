			...
			<table class="table">
				...
				<c:forEach items="${teacherList}" var="teacher">
					<tr align="center">
						...
						<td class="center">${teacher.realname}</td>
						<td class="center">${teacher.sex}</td>
						<td class="center">${teacher.birthday}</td>
						<td class="center">${teacher.contact}</td>
						<td class="center">${teacher.address}</td>
						<td class="center">${teacher.workdate}</td>
						<td class="center">${teacher.memo}</td>
					</tr>
				</c:forEach>
			</table>
			<ul class="pagination">
				<li>
					<form action="teacher/queryTeacherByCond.action" name="myform" method="post">

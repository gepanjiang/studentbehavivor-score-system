	...
	<div class="navbar navbar-default" role="navigation">
		<div class="navbar-header">
			<a class="" href="index.html"><span class="navbar-brand"><span class="fa fa-paper-plane"></span>
					欢迎使用学生日常行为评分系统</span></a>
		</div>
		<div class="navbar-collapse collapse" style="height: 1px;"></div>
	</div>
	<div class="dialog">
		<div class="panel panel-default">
			<p class="panel-heading no-collapse">欢迎使用学生日常行为评分系统</p>
			<div class="panel-body">
				<form action="<%=basePath%>login/login.action" name="myform" method="post" onSubmit="return checkLogin()">
					...
					<div class="form-group">
						<label>身份</label> <select name="role" id="role" class="form-controlspan12 form-control">
							<option value="学生">学生用户</option>
							<option value="教师">教师用户</option>
							<option value="管理员">管理用户</option>
						</select>
					</div>
